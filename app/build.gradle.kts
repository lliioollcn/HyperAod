...
android {
    namespace = "cn.lliiooll.hyperaod"
    compileSdk = 35

    defaultConfig {
        applicationId = "cn.lliiooll.hyperaod"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    androidResources.additionalParameters += listOf("--allow-reserved-package-id", "--package-id", "0xad")
